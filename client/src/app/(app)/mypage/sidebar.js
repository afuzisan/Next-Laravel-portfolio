        ...
        <div className="bg-background text-foreground rounded-lg shadow-lg overflow-hidden">
            <div className="p-6 max-h-[500px] overflow-auto">
                <div className="grid">
                    ...
                    <Link href="/mypage/stocks" className="flex items-center gap-4 hover:bg-gray-100 transition duration-300 p-2 rounded-lg">
                        <div className="bg-primary text-primary-foreground rounded-full p-3">
                    ...
                    <Link href="/mypage/accountdelete" className="flex items-center gap-4 hover:bg-gray-100 transition duration-300 p-2 rounded-lg">
